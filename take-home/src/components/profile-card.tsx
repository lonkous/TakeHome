...
export function SignInCard() {
  ...
  return (
    <ThemedView type="backgroundElement" style={styles.card}>
      ...
      <ThemedText type="subtitle" style={styles.center}>Greetings</ThemedText>
      ...
      >
        <ThemedText type="smallBold" style={styles.primaryText}>Sign in</ThemedText>
      </Pressable>
      {error ? (
...
function Detail({ label, value }: { label: string; value: string }) {
  return (
    <View style={styles.detailRow}>
      ...
      <ThemedText type="small" style={styles.detailValue} numberOfLines={1}>{value}</ThemedText>
    </View>
  );
}
